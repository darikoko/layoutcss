...
var resetCssPath = path.join(__dirname, "css", "reset.css");
var devCssPath = path.join(__dirname, "css", "dev.css");
var RESET_CSS = readFileSync(resetCssPath, { encoding: "utf8" });
var DEV_CSS = readFileSync(devCssPath, { encoding: "utf8" });
var componentMap = {
  "area-l": Area,
  "box-l": Box,
  "center-l": Center,
